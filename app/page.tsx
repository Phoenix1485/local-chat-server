  ...
  return (
    <main className="py-2 sm:py-6">
      ...
      >
        ...
        >
          <div>
            <p className="text-xs uppercase tracking-[0.24em] text-cyan-200/80">Live-Chat</p>
            <h1 className="mt-2 text-4xl font-semibold leading-tight text-white">Chat im Discord-Stil für deinen lokalen Server.</h1>
