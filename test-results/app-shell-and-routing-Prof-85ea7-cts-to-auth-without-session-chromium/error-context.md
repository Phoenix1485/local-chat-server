...
- Name: app-shell-and-routing.spec.ts >> Profile redirects to auth without session
- Location: tests\e2e\app-shell-and-routing.spec.ts:13:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_RESET at http://127.0.0.1:8080/profile
Call log:
  - navigating to "http://127.0.0.1:8080/profile", waiting until "load"
