...
- Name: app-shell-and-routing.spec.ts >> Admin panel renders without crashing
- Location: tests\e2e\app-shell-and-routing.spec.ts:3:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_RESET at http://127.0.0.1:8080/admin
Call log:
  - navigating to "http://127.0.0.1:8080/admin", waiting until "load"
