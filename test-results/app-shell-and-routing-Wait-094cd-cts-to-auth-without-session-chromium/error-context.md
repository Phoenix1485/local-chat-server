...
- Name: app-shell-and-routing.spec.ts >> Waiting redirects to auth without session
- Location: tests\e2e\app-shell-and-routing.spec.ts:18:5

# Error details

```
Error: page.goto: net::ERR_CONNECTION_RESET at http://127.0.0.1:8080/waiting
Call log:
  - navigating to "http://127.0.0.1:8080/waiting", waiting until "load"
